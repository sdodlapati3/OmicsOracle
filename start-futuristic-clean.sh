...
# Change to futuristic interface directory
...
# Start the server
echo "🌟 Starting Futuristic Interface server..."
echo "   URL: http://localhost:8001"
echo "   Press Ctrl+C to stop"
echo ""

# Try main server first, fallback to simple server
if timeout 5 python3 main.py 2>/dev/null; then
    echo "✅ Main server started successfully"
else
    echo "⚠️  Main server unavailable. Starting simple server..."
    echo "   ℹ️  This provides basic functionality for testing"
    echo ""
