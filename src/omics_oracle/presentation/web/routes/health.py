...
async def basic_health_check(
    health_data: Annotated[dict, Depends(health_check)]
) -> Dict[str, Any]:
...
async def readiness_check(
    ...
    try:
        ...
        try:
            ...
            checks["search_service"] = (
                "ready" if search_use_case else "not_ready"
            )
        ...
        try:
            ...
            checks["websocket_service"] = (
                "ready" if websocket_service else "not_ready"
            )
        except Exception as e:
