...
class WebSocketMonitor:
                ...
                with open(self.connection_log_file, "a") as f:
                    f.write(json.dumps({
                        **connection_info,
                        ...
                        "disconnected_at_readable": datetime.fromtimestamp(time.time()).strftime("%Y-%m-%d %H:%M:%S.%f")
                    }) + "\n")
    ...
    async def message_received(self, connection_id: str, message: str) -> None:
        ...
        if connection_id in self.connections:
            ...
            connection["last_activity_readable"] = datetime.fromtimestamp(time.time()).strftime("%Y-%m-%d %H:%M:%S.%f")
        ...
        if self.log_to_file:
            ...
            with open(self.message_log_file, "a") as f:
                f.write(json.dumps({
                    ...
                    "direction": "received",
                    "timestamp": time.time(),
                    "timestamp_readable": datetime.fromtimestamp(time.time()).strftime("%Y-%m-%d %H:%M:%S.%f"),
