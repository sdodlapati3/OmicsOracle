        ...
        <body>
            ...
            <div class="agent-sidebar" id="agent-sidebar">
                <div class="agent-sidebar-header">
                    <h3>🤖 Agent Status</h3>
                    <button class="close-sidebar" onclick="toggleAgentSidebar()">❌</button>
                </div>
            ...
            <div class="main-content" id="main-content">
                ...
                <div class="container">
                    <div class="main-interface-grid">
                        <div class="card">
                            ...
                            <button class="btn" onclick="performSearch()">🚀 Search with AI</button>
                ...
                <div class="card">
                    ...
                    <div class="feature-grid">
                        <button class="btn" onclick="createDemoVisualization('scatter_plot')">📈 Scatter Plot</button>
                        <button class="btn" onclick="createDemoVisualization('network_graph')">🕸️ Network Graph</button>
                        <button class="btn" onclick="createDemoVisualization('heatmap')">🗺️ Heatmap</button>
                        <button class="btn" onclick="createDemoVisualization('volcano_plot')">🌋 Volcano Plot</button>
                    </div>
                    <div id="visualization-container" style="margin-top: 20px; min-height: 400px; border: 1px solid rgba(255,255,255,0.2); border-radius: 10px; position: relative;">
                        <div style="padding: 20px; text-align: center; color: rgba(255,255,255,0.7);">
                            <p>🎯 Click buttons above to create interactive visualizations</p>
                            <p>📊 Visualizations will appear here with real-time updates</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="demo-area" id="demo-area">
                        <p>🎯 Enhanced interface ready! Modular components loaded successfully.</p>
            ...
            <script>
                function toggleAgentSidebar() {
                    ...
                    if (sidebar.classList.contains('open')) {
                        toggleBtn.innerHTML = '👁️'; // Eye icon when open
                    } else {
                        toggleBtn.innerHTML = '🤖'; // Robot icon when closed
                    }
                }
            </script>
        </body>
