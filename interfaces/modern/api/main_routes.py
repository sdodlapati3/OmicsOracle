...
def index():
    ...
    try:
        ...
        current_app.logger.info(f"Main interface loaded, pipeline available: {omics_available}")
...
def search_web():
    ...
    try:
        ...
        current_app.logger.info(f"Web search completed: {len(results.results)} results")
