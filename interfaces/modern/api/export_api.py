...
def export_search_results():
    ...
    try:
        ...
        logger.info(
            f"Export request: {export_request.query} -> {export_request.format}"
        )
        ...
        export_response = export_service.export_search_results(
            search_results, export_request
        )
...
def get_supported_formats():
    ...
    try:
        ...
        return jsonify({"supported_formats": formats, "default_format": "csv"})
