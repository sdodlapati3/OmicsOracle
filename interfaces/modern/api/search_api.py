...
from services import SearchService, CacheService
from core.logging_config import get_api_logger
from core.exceptions import ValidationException, SearchException
...
cache_service = CacheService(config.CACHE_DIR, config.CACHE_TTL, config.CACHE_ENABLED)
...
def search():
    ...
    try:
        ...
        logger.info(f"Search request: {search_query.query} (page: {search_query.page})")
