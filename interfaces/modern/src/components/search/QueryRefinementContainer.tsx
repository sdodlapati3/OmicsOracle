...
export const QueryRefinementContainer: React.FC<QueryRefinementContainerProps> = ({
  ...
  const handleSuggestionEdit = (originalSuggestion: QuerySuggestion, editedQuery: string) => {
    onQueryRefined(editedQuery);

    // Submit feedback for edited suggestion
    onFeedbackSubmitted({
      original_query: originalQuery,
      suggested_query: editedQuery,
      user_action: 'suggestion_edited',
      was_helpful: true,
    });
  };
          ...
          <div className="p-6">
            ...
            {activeTab === 'suggestions' && (
              <QuerySuggestions
                ...
                onSuggestionEdited={handleSuggestionEdit}
