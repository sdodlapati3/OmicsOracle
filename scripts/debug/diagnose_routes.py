...
def main():
    try:
        ...
        try:
            from src.omics_oracle.presentation.web.routes.v1 import router as v1_router
        ...
        try:
            from src.omics_oracle.presentation.web.routes.v2 import router as v2_router
