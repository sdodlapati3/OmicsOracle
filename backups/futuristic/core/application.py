...
from ui.routes_clean import create_ui_router  # Use clean version with static files
...
def create_app(config: EnhancedConfig) -> FastAPI:
    ...
    app.include_router(create_websocket_router(config), prefix="", tags=["WebSocket"])
