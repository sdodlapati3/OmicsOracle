...
async def get_event_bus(container: Annotated[Container, Depends(get_di_container)]) -> EventBus:
    """Get event bus."""
    try:
...
async def get_cache_service(container: Annotated[Container, Depends(get_di_container)]) -> MemoryCache:
    """Get cache service."""
    try:
...
async def get_room_manager(container: Annotated[Container, Depends(get_di_container)]) -> RoomManager:
...
async def get_realtime_service(container: Annotated[Container, Depends(get_di_container)]) -> RealtimeService:
...
async def get_cache_hierarchy(container: Annotated[Container, Depends(get_di_container)]) -> CacheHierarchy:
...
async def get_service_registry(container: Annotated[Container, Depends(get_di_container)]) -> ServiceRegistry:
