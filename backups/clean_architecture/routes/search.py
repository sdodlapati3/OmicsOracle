...
from ..dependencies import get_event_bus, get_search_use_case, get_websocket_service
...
async def search_datasets(
    ...
    search_use_case: Annotated[EnhancedSearchDatasetsUseCase, Depends(get_search_use_case)],
...
async def get_dataset_by_id(
    ...
    try:
        ...
        request = SearchRequestDTO(query=geo_id, max_results=1, search_type="exact_match")
