...
class BatchProcessor:
    ...
    def export_batch_results(self, job_id: str, format: str = "json") -> Optional[Dict[str, Any]]:
        """
        ...
        if format == "json":
            ...
            return {
                "job_summary": {
                    ...
                    "average_time_per_query": total_processing_time / batch_job.total_queries
                ...
                "query_results": [
                    {
                        ...
                        "has_ai_summary": bool(q.result and q.result.get("ai_summaries"))
                        if q.result
                        else False,
                        "processing_time": q.processing_time,
                        "error": q.error,
