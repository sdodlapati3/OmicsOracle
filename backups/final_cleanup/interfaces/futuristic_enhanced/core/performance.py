...
class PerformanceTracker:
    ...
    def get_agent_stats(self, agent_type: str = None) -> Dict[str, Any]:
        ...
        if agent_type:
            ...
            relevant_stats = {k: v for k, v in self.agent_stats.items() if k.startswith(agent_type)}
        else:
    ...
    def get_system_metrics(self) -> Dict[str, Any]:
        ...
        requests_per_minute = (recent_request_count / 5) if recent_request_count > 0 else 0
    ...
    def get_recent_slow_requests(self, threshold_ms: float = 1000, limit: int = 10) -> List[Dict[str, Any]]:
