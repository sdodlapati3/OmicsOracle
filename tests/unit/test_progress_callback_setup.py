...
class TestProgressCallback:
    ...
    def mock_pipeline(self, mock_config):
        ...
        with patch('src.omics_oracle.geo_tools.geo_client.UnifiedGEOClient'), \
             patch('src.omics_oracle.services.summarizer.SummarizationService'), \
             patch('src.omics_oracle.nlp.prompt_interpreter.PromptInterpreter'), \
             patch('src.omics_oracle.nlp.biomedical_ner.BiomedicalNER'), \
             patch('src.omics_oracle.nlp.biomedical_ner.EnhancedBiologicalSynonymMapper'), \
             patch('src.omics_oracle.services.improved_search.ImprovedSearchService'):
