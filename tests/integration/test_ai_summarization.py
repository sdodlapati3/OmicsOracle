...
class TestAISummarizationIntegration:
    ...
    def sample_geo_metadata(self):
        ...
        return {
            ...
            "samples": ["Sample1", "Sample2", "Sample3"],  # Fix: make samples a list
    ...
    def test_batch_summarization(self, mock_config):
        ...
        datasets = [
            {"accession": "GSE001", "title": "Study 1", "summary": "First study", "samples": ["S1"]},
            {"accession": "GSE002", "title": "Study 2", "summary": "Second study", "samples": ["S1", "S2"]},
            {"accession": "GSE003", "title": "Study 3", "summary": "Third study", "samples": ["S1", "S2", "S3"]}
        ]
